 ...
 */
public class ModifeirAvisController implements Initializable {
  Connection cnx = DataS.getInstance().getConnection();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        notte = MainKais.avis.getNoteService()+"";
       texttttt.setText(MainKais.avis.getDetailAvisService());
       notreat.setText(MainKais.avis.getNoteService()+"");
      init();
    Selartcle.getItems().addAll(a);
          if(gr1.isSelected()){
            notte="1";
    ...
    private void AjouterAvis(ActionEvent event) throws IOException {
       ...
       if (texttttt.getText().equals("")){
        ...
        if (x == 0){
            Avis a = new Avis(MainKais.avis.getIdAvis(),texttttt.getText(),Integer.parseInt(notte), Selartcle.getValue(), 1);
            sa.modifier(a);
