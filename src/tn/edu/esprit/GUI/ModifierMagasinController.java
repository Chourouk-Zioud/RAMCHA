...
public class ModifierMagasinController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        InsializeLabel();
       idMagasin.setText(""+Main.mag.getIdMagasin());
       NomMagasin.setText(Main.mag.getNomMagasin());
       Adressemagasin.setText(Main.mag.getAdresseMagasin());
       TelephoneMagasin.setText(Main.mag.getTelMagasin());
       EmailMagasin.setText(Main.mag.getEmailMagasin());
    ...
    private void Enregistremagasin(ActionEvent event) throws IOException {
        ...
        if (x == 0)
        {
        Magasin m = new Magasin(Main.mag.getIdMagasin(),NomMagasin.getText(), Adressemagasin.getText(), EmailMagasin.getText(), TelephoneMagasin.getText());
        sm.modifier(m);
