       ...
       if (NomRec.getText().equals("")){
        ...
        x=1;
                   ...
                   if (x == 0 )
                   {
                       ...
                       Reclamation r = new Reclamation(NomRec.getText(), prenomRec.getText(), EmailRec.getText(), imageeget, TelRec.getText(), d1, d2, DescRec.getText(), "Non traiter", ServicereclameSel.getValue().getNomService());
                       sr.ajouter(r);
                                    if(MainKais.role == "admin"){
            DescRec.getScene().getWindow().hide();
              Parent root = FXMLLoader.load(getClass().getResource("GestionReclamation.fxml"));
