...
public class Utilisateur {
    ...
    public Utilisateur( String cinUser, String nomUser, String prenomUser, Date ddnUser, String adressUser, int codePostalUser, String numUser, String loginUser, String passwUser, String image) {
        this.idUser = idUser;
    ...
    public String toString() {
        return  "cinUser=" + cinUser + ", nomUser=" + nomUser + ", prenomUser=" + prenomUser + ", ddnUser=" + ddnUser + ", adressUser=" + adressUser + ", codePostalUser=" + codePostalUser + ", numUser=" + numUser + ", loginUser=" + loginUser + ", passwUser=" + passwUser+", image=" + image ;
    }
