...
public class Article {
    ...
    public Article(int idArticle, String nomArticle, String marqueArticle, String typeArticle, int disponibiliteArticle, String couleurArticle, float prixArticle, String tailleArticle, String descriptionArticle, String screenshot, int idMagasin, int idCategorieArticle) {
    ...
    public Article(String nomArticle, String marqueArticle, String typeArticle, int disponibiliteArticle, String couleurArticle, float prixArticle, String tailleArticle, String descriptionArticle, String screenshot, int idMagasin, int idCategorieArticle) {
        this.nomArticle = nomArticle;
        this.marqueArticle = marqueArticle;
        this.typeArticle = typeArticle;
        this.disponibiliteArticle = disponibiliteArticle;
